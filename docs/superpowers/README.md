...
**The newest handoff is the only one with current status: [`HANDOFF-2026-09-20.md`](HANDOFF-2026-09-20.md).**
...
|---|---|
| [`HANDOFF-2026-09-20.md`](HANDOFF-2026-09-20.md) | **CURRENT STATUS.** #64 the stuck-process watchdog; **why `IgnoreNew` makes a startup check unreachable** and which log lines actually prove a process started; why the deadman is a daemon thread and not an APScheduler job; **the microsecond defect only a real clock could produce** |
